...
- Mean voltage: {stats.get('mean', 'N/A')} 渭V
- Standard deviation: {stats.get('std', 'N/A')} 渭V
- Voltage range: {stats.get('min', 'N/A')} to {stats.get('max', 'N/A')} 渭V
- Peak-to-peak amplitude: {stats.get('peak_to_peak', 'N/A')} 渭V
- RMS value: {stats.get('rms', 'N/A')} 渭V
